'use strict';Object.defineProperty(exports,'__esModule',{value:true});var nodeHtmlParser=require('node-html-parser');/*! *****************************************************************************
                ...
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, fetch("https://www.youtube.com/watch?v=" + identifier, {
                                ...
                                .then(function (html) { return nodeHtmlParser.parse(html); })
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, fetch(transcriptUrl)
                                .then(function (res) { return res.text(); })
                                .then(function (xml) { return nodeHtmlParser.parse(xml); })];
                    case 3:
